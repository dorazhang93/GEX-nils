...
if __name__ == "__main__":
    ...
    def needs_wd(name):
        return all(x not in name for x in ['.norm'])
    ...
    # progress = zero.ProgressTracker(patience=None)
    ...
    for epoch in stream.epochs(args['training']['n_epochs']):
        ...
        training_log[TRAIN].append(epoch_losses)
    ...
    with open(output / "training_log.pkl", 'wb') as file:
        pkl.dump(training_log, file)
    print('Done!')
